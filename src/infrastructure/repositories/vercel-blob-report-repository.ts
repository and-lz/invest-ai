...
export class VercelBlobReportRepository implements ReportRepository {
  private readonly fileManager: VercelBlobFileManager;

  constructor(userId: string) {
    this.fileManager = new VercelBlobFileManager(userId);
  }
