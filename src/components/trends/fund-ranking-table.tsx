...
import { GLOSSARY_FUNDOS_EM_ALTA } from "@/lib/financial-glossary";
...
export function TabelaRankingFundos({ fundosEmAlta }: TabelaRankingFundosProps) {
  ...
  const { itensOrdenados, colunaOrdenacao, direcaoOrdenacao, alternarOrdenacao } =
    useTableSorting<AtivoRanking, ColunaFundos>(fundosEmAlta, obterValor);
    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          Fundos em Alta
          <InfoTooltip conteudo={GLOSSARY_FUNDOS_EM_ALTA.explicacao} />
        </CardTitle>
