  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <CardIndicador
        ...
        glossario={GLOSSARY_IBOVESPA_INDICE.explicacao}
      />
      ...
      <CardIndicador
        ...
        glossario={GLOSSARY_DOLAR.explicacao}
      />
      ...
      <CardIndicador
        ...
        glossario={GLOSSARY_SELIC_META.explicacao}
      />
      ...
      <CardIndicador
        ...
        icon={<Percent className="text-muted-foreground h-5 w-5" aria-hidden="true" />}
        glossario={GLOSSARY_IPCA_INDICE.explicacao}
      />
    </div>
  );
}
