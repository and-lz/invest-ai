            ...
            <div className="grid gap-3 md:grid-cols-3">
              {analise.analiseRendaPassiva.yieldMedioMensal !== null && (
                <div>
                  ...
                  <p className="text-lg font-semibold">
                    {formatarPercentualSimples(analise.analiseRendaPassiva.yieldMedioMensal)}
                  </p>
                </div>
              )}
              {analise.analiseRendaPassiva.yieldAnualizado !== null && (
                <div>
                  ...
                  <p className="text-lg font-semibold">
                    {formatarPercentualSimples(analise.analiseRendaPassiva.yieldAnualizado)}
                  </p>
                </div>
              )}
              {analise.analiseRendaPassiva.yieldOnCost !== null && (
                <div>
                  ...
                  <p className="text-lg font-semibold">
                    {formatarPercentualSimples(analise.analiseRendaPassiva.yieldOnCost)}
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="grid gap-3 md:grid-cols-3 lg:grid-cols-5">
              ...
              {analise.avaliacaoFundamentalista.dividendYield !== null && (
                <div>
                  ...
                  <p className="text-lg font-semibold">
                    {formatarPercentualSimples(analise.avaliacaoFundamentalista.dividendYield)}
                  </p>
                </div>
              )}
